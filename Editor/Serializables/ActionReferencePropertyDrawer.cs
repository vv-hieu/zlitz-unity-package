...
namespace Zlitz.Utility.Serializables.Editor
{
    ...
    [CustomPropertyDrawer(typeof(ActionReference<,,>))]
    [CustomPropertyDrawer(typeof(ActionReference<,,,>))]
    public class ActionReferencePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedActionReference actionReference = new SerializedActionReference(property);
        ...
        private class SerializedActionReference
        {
            ...
            public SerializedActionReference(SerializedProperty property)
            {
