...
{
	[CustomPropertyDrawer(typeof(DictBase), true)]
	public class DictPropertyDrawer : PropertyDrawer
	{
		private static readonly string s_keysFieldName   = "m_keys";
		private static readonly string s_valuesFieldName = "m_values";
		private static readonly float  s_indentWidth     = 15.0f;
		...
		private class ConflictState
		{
			...
			public float  conflictLineHeight            = 0.0f;
		}
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			SerializedProperty keyArrayProperty   = property.FindPropertyRelative(s_keysFieldName);
			SerializedProperty valueArrayProperty = property.FindPropertyRelative(s_valuesFieldName);
			...
			conflictState.conflictLineHeight            = 0.0f;
		...
		private static float DrawKeyValueLineSimple(SerializedProperty keyProperty, SerializedProperty valueProperty, string keyLabel, string valueLabel, Rect linePosition)
		{
			...
			keyPosition.width = labelWidth - s_indentWidth;
		...
		public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
		{
			...
			if (property.isExpanded)
			{
				SerializedProperty keysProperty = property.FindPropertyRelative(s_keysFieldName);
				SerializedProperty valuesProperty = property.FindPropertyRelative(s_valuesFieldName);
	...
	[CustomPropertyDrawer(typeof(SetBase.Storage), true)]
	public class SetStoragePropertyDrawer : PropertyDrawer
	{
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			property.Next(true);
