...
namespace Zlitz.Utility.Serializables.Runtime
{
	...
	[Serializable]
	public abstract class DictBase<TKey, TValue, TValueStorage> : DictBase, IDictionary<TKey, TValue>, IDictionary, ISerializationCallbackReceiver, IDeserializationCallback, ISerializable
	{
		[SerializeField]
		private TKey[] m_keys;
		...
		public DictBase(IDictionary<TKey, TValue> dict)
		{
		...
		#region Implement IDeserializationCallback
		...
		protected DictBase(SerializationInfo info, StreamingContext context)
		{
	...
	{
		public class Storage<T> : DictBase.Storage
		{
			public T data;
		}
	}
	...
	[Serializable]
	public class Dict<TKey, TValue> : DictBase<TKey, TValue, TValue>
	{
		public Dict() 
		{ 
		}
	...
	[Serializable]
	public class Dict<TKey, TValue, TValueStorage> : DictBase<TKey, TValue, TValueStorage> where TValueStorage : Dict.Storage<TValue>, new()
	{
		public Dict() 
		{ 
		}
